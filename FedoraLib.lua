...
ContentContainer.Size = UDim2.new(1, -36, 1, -95)
ContentContainer.Position = UDim2.new(0, 18, 0, 88)
...
local tabButtons = {}
    ...
    function Window:CreateTab(tabNameInput)
        ...
        local scrollBasis = math.min(totalTabsPlanned, tabsBeforeScroll)
        local scaleWidth = 1 / scrollBasis
        local fixedPixelWidth = TabBar.AbsoluteSize.X / scrollBasis

for i, existingBtn in ipairs(tabButtons) do
            existingBtn.Size = UDim2.new(0, fixedPixelWidth - 2, 1, -10)
            existingBtn.Position = UDim2.new(0, (i - 1) * fixedPixelWidth + 1, 0, 5)
        end

        local btn = Instance.new("TextButton")
btn.Size = UDim2.new(0, fixedPixelWidth - 6, 1, -12)
btn.Position = UDim2.new(0, (index - 1) * fixedPixelWidth + 3, 0, 6)
